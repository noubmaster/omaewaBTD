...
-- Copiando dados para a tabela memes.album: ~8 rows (aproximadamente)
DELETE FROM `album`;
...
-- Copiando dados para a tabela memes.avaliacao: ~59 rows (aproximadamente)
...
-- Copiando dados para a tabela memes.composicao: ~25 rows (aproximadamente)
...
-- Copiando dados para a tabela memes.musica: ~23 rows (aproximadamente)
DELETE FROM `musica`;
...
-- Copiando dados para a tabela memes.participa: ~25 rows (aproximadamente)
...
-- Copiando dados para a tabela memes.score: ~14 rows (aproximadamente)
DELETE FROM `score`;
...
INSERT INTO `usuario` (`idUsuario`, `email`, `idR`, `tipo`, `perfil`) VALUES
	...
	(1028, 'zplaysgames@gmail.com', '113790802213871725270', 1, 'https://lh6.googleusercontent.com/--yBoPqV478E/AAAAAAAAAAI/AAAAAAAAAAA/ANQ0kf7A24aQ9ddbaSZIz9RWBTGFfRyVCA/s96-c/photo.jpg');
